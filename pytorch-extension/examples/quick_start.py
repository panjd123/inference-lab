...
def test_square():
    ...
    y = pytorch_extension.square(x)

    print("Input:", x)
    print("Squared:", y)

    x_cuda = torch.tensor([1.0, 2.0, 3.0], device="cuda")
    y_cuda = pytorch_extension.square(x_cuda)
...
def test_matmul_rc():
    ...
    print("pytorch_extension:", pytorch_extension.matmul_rowmajor_columnmajor(a, b))
    ...
    print(
        ...
        pytorch_extension.matmul_rowmajor_columnmajor(a_cuda, b_cuda),
    )
