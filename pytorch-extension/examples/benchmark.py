...
for N in tqdm([384, 768, 1024, 1536, 2048, 4096, 8192]):
    ...
    t_cpu_pytorch = benchmark.Timer(
        ...
        setup="import torch; import pytorch_extension;",
        globals={"a": a, "b": b},
    ...
    t_cpu_extension = benchmark.Timer(
        stmt="pytorch_extension.matmul_rowmajor_columnmajor(a, b)",
        setup="import torch; import pytorch_extension;",
        globals={"a": a, "b": b},
        num_threads=num_threads,
        label="pytorch_extension.matmul_rowmajor_columnmajor",
        description="CPU",
    )
    ...
    t_cuda_extension = benchmark.Timer(
        stmt="pytorch_extension.matmul_rowmajor_columnmajor(a_cuda, b_cuda)",
        setup="import torch; import pytorch_extension;",
        globals={"a_cuda": a_cuda, "b_cuda": b_cuda},
        num_threads=num_threads,
        label="pytorch_extension.matmul_rowmajor_columnmajor",
